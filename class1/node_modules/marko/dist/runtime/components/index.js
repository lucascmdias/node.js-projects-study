...
function addComponentsFromContext(componentsContext, componentsToHydrate) {
  ...
  for (var i = 0; i < len; i++) {
    ...
    var isLegacy = componentDef.aj_;

    var state = component.state;
    var input = component.input || 0;
    var typeName = component.typeName;
    var customEvents = component.Q_;
    var scope = component.J_;
    var bubblingDomEvents = component.P_;
    ...
    if (isLegacy) {
      ...
      if (!(flags & FLAG_WILL_RERENDER_IN_BROWSER) || flags & FLAG_OLD_HYDRATE_NO_CREATE) {
        component.L_ = undefined; // We don't use `delete` to avoid V8 deoptimization
        component.S_ = undefined; // We don't use `delete` to avoid V8 deoptimization
        component.typeName = undefined;
        component.id = undefined;
        component.Q_ = undefined;
        component.J_ = undefined;
        component.P_ = undefined;
        component._T_ = undefined;
        component._U_ = undefined;
  ...
  var nestedContexts = componentsContext._N_;
...
function getInitComponentsData(out, componentDefs) {
  ...
  const TYPE_INDEX = 1;
  const typesLookup = $global.al_ || ($global.al_ = new Map());
  let newTypes;
