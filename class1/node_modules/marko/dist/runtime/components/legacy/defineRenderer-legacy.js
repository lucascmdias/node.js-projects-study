...
var resolveComponentKey = modernRenderer.aq_;
...
module.exports = function defineRenderer(renderingLogic) {
  ...
  if (!renderer) {
    ...
    renderer = function renderer(input, out) {
      ...
      var isReceivingNewInput = !component || component.as_;
      var parentComponentDef;

      if (component) {
        delete component.as_;
      }
      ...
      if (!component && componentLookup) {
        ...
        if ((parentComponentDef = componentsContext._M_) && key != null) {
      ...
      if (isReceivingNewInput) {
        ...
        newProps = newProps || component.at_;
        widgetBody = component._L_;
