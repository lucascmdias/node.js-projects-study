...
var escapeXmlString = escapeXmlHelper.aU_;
...
var proto = AsyncStream.prototype = {
  ...
  _doFinish: function () {
    ...
    if (state.writer.end) {
      ...
      state.events.emit("finish", this.aW_());
    }
  },
  ...
  aT_: function (tagName, elementAttrs, key, componentDef, props) {
  ...
  aR_: function (name, elementAttrs, key, componentDef, props) {
